  ...
  return (
    <div className="space-y-6">
      <div className="text-center">
        <h3 className="text-xl font-semibold text-white mb-2">Built for Everyone</h3>
        <p className="text-[#a2c398] text-sm">
          MiniLend combines the power of DeFi with regulatory compliance to provide accessible financial services
        </p>
      </div>
          ...
          return (
            ...
            >
              <CardContent className="p-4">
                ...
                <div className="text-sm font-medium text-[#a2c398] mb-1">{stat.label}</div>
                <div className="text-xs text-[#a2c398]/80">{stat.description}</div>
              </CardContent>
            </Card>
          );
        })}
