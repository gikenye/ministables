...
export default function AuthError() {
  ...
  useEffect(() => {
    ...
    const errorMessages: Record<string, string> = {
      "CredentialsSignin": "Failed to sign in with your credentials. Please try again.",
      ...
      <div className="bg-white rounded-lg shadow-lg p-6 max-w-md w-full">
        <div className="text-center">
          ...
          <div className="flex flex-col space-y-3">
            <Link href="/self" className="bg-primary text-white py-2 px-4 rounded-md hover:bg-primary/90 transition-colors">
              Try Again
            </Link>
